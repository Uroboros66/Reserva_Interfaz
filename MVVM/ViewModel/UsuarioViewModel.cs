...
namespace Reserva_Interfaz.MVVM.ViewModel
{
    public partial class UsuarioViewModel : ObservableObject
    {
        ...
        // Propiedades vinculadas a los campos de entrada de usuario y contraseña
        [ObservableProperty]
        ...
        public async Task RegisterAsync()
        {
            ...
            try
            {
                var response = await _httpClient.PostAsJsonAsync("http://localhost:7071/api/Usuario/signup", user);
